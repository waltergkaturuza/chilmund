...
export interface User {
  ...
  name?: string | null;
  /**
   * Admins can manage users and settings. Editors can manage content only.
   */
  roles: ('admin' | 'editor')[];
  updatedAt: string;
  createdAt: string;
...
export interface Event {
  ...
  eventType?: ('Conference' | 'Exhibition' | 'Workshop' | 'Award Ceremony' | 'CSR Activity' | 'Other') | null;
...
/**
 * Email subscribers from the website newsletter sign-up form.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface NewsletterSubscriber {
  ...
  email: string;
  /**
   * Optional — captured if provided.
   */
  name?: string | null;
  /**
   * Set to "Unsubscribed" if the user opts out.
   */
...
export interface CompanyContact {
  id: number;
  enableFloatingActions?: boolean | null;
  /**
   * Primary sales line shown to visitors (e.g. Harare)
   */
  salesPhone?: string | null;
  /**
   * E.164 for click-to-call
   */
  salesPhoneTel?: string | null;
  phoneBinduraDisplay?: string | null;
  phoneBinduraTel?: string | null;
...
export interface CompanyContactSelect<T extends boolean = true> {
  enableFloatingActions?: T;
  salesPhone?: T;
  salesPhoneTel?: T;
  phoneBinduraDisplay?: T;
  phoneBinduraTel?: T;
  salesEmail?: T;
  adminEmail?: T;
  whatsappNumber?: T;

    ...
    >
      ...
      <div className="container relative z-10 flex justify-center px-4 py-24 md:py-28">
        <div className="max-w-4xl text-center">
          {richText && (
            <RichText
              className="mb-0 prose-headings:font-extrabold prose-headings:tracking-tight prose-headings:text-white prose-p:text-lg prose-p:text-white/85 prose-strong:text-white prose-a:text-amber-300 md:prose-p:text-xl [&_h1]:text-4xl [&_h1]:md:text-5xl [&_h1]:lg:text-6xl [&_h1]:leading-[1.08]"
              data={richText}
              enableGutter={false}
            />
          )}

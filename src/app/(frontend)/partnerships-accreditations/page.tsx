    ...
    <article className="min-h-screen">
      ...
      <section className="bg-white dark:bg-slate-950">
        <div className="container mx-auto px-4 py-10">
          <h2 className="text-center text-xl font-bold text-slate-900 dark:text-white">Certifications</h2>
            ...
            {partners.map((p) => (
              ...
              >
                ...
                <ul className="mt-4 space-y-2">
                  {p.items.map((item) => (
                    <li key={item} className="text-sm text-slate-600 dark:text-white/60">
                      {item}
                    </li>
                  ))}
                </ul>
      ...
      <section className="bg-slate-50 dark:bg-slate-900">
        <div className="container mx-auto px-4 py-10 text-center">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white">Explore Our Markets</h2>

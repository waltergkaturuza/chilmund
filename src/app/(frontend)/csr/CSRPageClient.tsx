...
const CATEGORY_META: Record<string, { label: string; color: string }> = {
  community: { label: 'Community Development', color: 'bg-rose-600' },
  education: { label: 'Education & Training', color: 'bg-blue-600' },
  environment: { label: 'Environment & Sustainability', color: 'bg-emerald-600' },
  health: { label: 'Health & Wellness', color: 'bg-red-600' },
  water: { label: 'Water & Sanitation', color: 'bg-cyan-600' },
  youth: { label: 'Youth Empowerment', color: 'bg-violet-600' },
  employee: { label: 'Employee Welfare', color: 'bg-amber-600' },
          ...
          <div className="space-y-8">
            ...
            {csrHighlightSlides.length > 0 && (
              <div className="rounded-xl border border-slate-200 bg-slate-50/90 p-6 dark:border-white/10 dark:bg-slate-900/50 sm:p-8">
                <h2 className="text-center text-lg font-bold text-slate-900 dark:text-white sm:text-xl">
                  CSR in focus
                </h2>

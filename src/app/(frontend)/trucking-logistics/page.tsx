...
const capabilities = [
  { title: 'Dedicated Fleet', desc: 'Own fleet of trucks purpose-built for safe chemical transportation, ensuring reliable and timely deliveries.' },
  { title: 'Regional Reach', desc: 'Distribution network covering Zimbabwe, Zambia, Malawi, Mozambique, DRC, and other Southern and East African markets.' },
  { title: 'Strategic Warehousing', desc: 'Warehousing facilities at key distribution points for buffer stock and rapid deployment to customers.' },
  { title: 'Safety First', desc: 'All drivers trained in hazardous materials handling. Vehicles equipped with spill kits and safety equipment.' },
  { title: 'On-Time Delivery', desc: 'GPS-tracked fleet with real-time monitoring to ensure on-time delivery and full supply chain visibility.' },
  { title: 'Flexible Packaging', desc: 'Available in 25 kg bags, 50 kg bags, 1-tonne bulk bags, and loose bulk options to suit customer requirements.' },
]
  ...
  return (
    <article className="min-h-screen">
      ...
      <section className="bg-slate-50 dark:bg-slate-900">
        <div className="relative mx-auto w-full max-w-none px-3 py-10 sm:px-4 md:px-5 lg:px-7 xl:px-10">
